...
@section('titulo')
<title>Guías de Retención</title>
@endsection
...
<div class="container text-center">
  <div class="row">
    <div class="col-sm-6 my-1">
      <form method="GET" action="{{ route('ruta.documentos.retencion') }}">
...
<div class="container mt-4">
  ...
  <div class="pagination justify-content-center">
    {{ $retencion->appends(Request::except('page'))->links('vendor.pagination.bootstrap-4') }}
  </div>
